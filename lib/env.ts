...
const envSchema = z.object({
  ...
  RATE_LIMIT_MAX_ADMIN_AUTH_ATTEMPTS: z.coerce.number().int().positive().default(5),
  RATE_LIMIT_MAX_CUSTOMER_AUTH_ATTEMPTS: z.coerce.number().int().positive().default(8),
...
function validateEnv() {
  const parsed = envSchema.safeParse({
    ...
    RATE_LIMIT_MAX_ADMIN_AUTH_ATTEMPTS: process.env.RATE_LIMIT_MAX_ADMIN_AUTH_ATTEMPTS,
    RATE_LIMIT_MAX_CUSTOMER_AUTH_ATTEMPTS:
      process.env.RATE_LIMIT_MAX_CUSTOMER_AUTH_ATTEMPTS,
