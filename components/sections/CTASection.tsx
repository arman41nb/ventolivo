  ...
  return (
    <section id="contact" className="px-4 py-20 md:px-6">
      <div className="mx-auto grid max-w-[1380px] gap-6 lg:grid-cols-[0.88fr_1.12fr]">
        ...
        >
          <div className="relative luxe-panel-float">
            ...
            {renderEditable(
              ...
              "storyClosing",
              "CTA quote",
              <p className="mt-2 font-serif text-[2rem] leading-[1.08] text-[#5d3d27] md:text-[2.35rem] luxe-heading-glide">
                {content.quote}
              </p>,
              "block",
            )}
        ...
        <ViewportReveal
          className="relative overflow-hidden rounded-[32px] border border-brown/8 bg-[radial-gradient(circle_at_top_right,rgba(167,127,88,0.12),transparent_26%),linear-gradient(135deg,rgba(255,252,247,0.88),rgba(239,228,215,0.92))] p-8 shadow-[0_14px_32px_rgba(72,49,30,0.08)] md:p-10"
          delay={80}
          distance={32}
          duration={560}
        >
          <div className="relative luxe-panel-float luxe-panel-float-delay-2">
            ...
            <h2 className="font-serif text-[2.8rem] leading-[0.96] text-dark md:text-[4rem] luxe-heading-glide">
              ...
              {renderEditable(
                ...
                "ctaTitleLine2",
                "CTA line 2",
                <em className="font-medium italic text-[#a77f58]">{content.title.line2}</em>,
                "block w-fit",
              )}
            </h2>
            {renderEditable(
            ...
            {preview ? (
              renderEditable(
                ...
                "ctaButtonLabel",
                "CTA button",
                <span className="inline-flex items-center gap-[10px] rounded-full bg-[linear-gradient(135deg,#7a5638_0%,#5d3d27_100%)] px-7 py-4 text-[13px] font-medium uppercase tracking-[0.16em] text-white shadow-[0_14px_28px_rgba(93,61,39,0.18)] transition-transform hover:-translate-y-0.5">
